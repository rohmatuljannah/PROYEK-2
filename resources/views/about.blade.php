...
<div class="ftco-blocks-cover-1">
  ...
  <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('images/7.jpg')">
    <div class="container">
      <div class="row align-items-center ">

        <div class="col-md-5 mt-5 pt-5">
          <span class="text-cursive h3 text-red">Welcome To Our Website</span>
          <h1 class="mb-3 font-weight-bold text-teal" style="font-size: 40px">Tentang Kami</h1>
          <p><a href="index.html" class="text-white" style="font-size: 20px">Home</a> <span class="mx-3">/</span> <strong style="font-size: 20px">Tentang Kami</strong></p>
        </div>
    ...
    <div class="row">
      ...
      <div class="col-md-5 ml-auto pl-md-5">
        ...
        <p><span>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Et harum, magni sequi nostrum maxime
            enim.</span><span>Magnam id atque dicta deleniti, ipsam ipsum distinctio. Facilis praesentium voluptatem
            accusamus, earum veritatis, laudantium.</span></p>
