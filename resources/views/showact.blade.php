        ...
        <div class="container">
          <div class="row align-items-center ">
            ...
            <div class="col-md-5 mt-5 pt-5">
              ...
              <h1 class="mb-3 font-weight-bold text-teal" style="font-size: 40px"> Detail Aktivitas </h1>
        ...
        <div class="row row-cols-1 row-cols-md-3">
            ...
            <div class="card" style="width: 70rem;">
              <div class="card-body">
                ...
                <a href="{{ url('/login')}}" class ="btn btn-info"> Jadi Relawan</a>
              <!--   <form action="{{ $data_aktivitas -> id }}" method="post" class="d-inline">
                @method('delete')
                @csrf
                <button type="submit" class="btn btn-danger"> Delete </button>
                </form> -->
                <a href="/act" type="button" class="btn btn-primary">Back</a>
              </div>
            </div>
          </div>
        <br>
