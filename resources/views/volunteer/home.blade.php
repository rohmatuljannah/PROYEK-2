...
<div class="ftco-blocks-cover-1">
  ...
  <div class="site-section-cover overlay" data-stellar-background-ratio="0.5" style="background-image: url('images/6.jpg')">
    <div class="container">
      <div class="row align-items-center ">

        <div class="col-md-5 mt-5 pt-5">
          <span class="text-cursive h3 text-red">Home</span>
          <h1 class="mb-2 font-weight-bold text-teal" style="font-size: 40px">Welcome to Dashboard Volunteer!</h1>
