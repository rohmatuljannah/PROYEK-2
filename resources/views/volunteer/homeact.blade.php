        ...
        @foreach ($data_aktivitas as $akt)
          <div class="col-lg-4">
            <div class="package text-center bg-white">
              <span class="img-wrap"><img src="images/a.jpg" alt="Image" class="img-fluid"></span>
                  <table>
                       <tr style="text-align: center;">
                         <td style="font-size: 20px; font-weight: bold;  color: #000000; font-family: Bell MT">{{ $akt->nama_aktivitas }}</td>
                       </tr>
                       <tr>
                         <td></td>
                       </tr>
              ...
              <br>
              <p><a href="/detailact/{{ $akt -> id}} " class="btn btn-primary">Detail</a></p>
            </div>
          </div>
          @endforeach
        </div>
